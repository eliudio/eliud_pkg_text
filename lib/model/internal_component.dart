...
class ListComponent extends StatelessWidget with HasFab {
  ...
  void initWidget() {
    if (componentId == 'htmls') widget = HtmlListWidget();
  }
      ...
      providers: [
        BlocProvider<HtmlListBloc>(
          create: (context) => HtmlListBloc(
            htmlRepository: htmlRepository(appId: appId)!,
          )..add(LoadHtmlList()),
        )
      ],
      child: widget!,
...
class DropdownButtonComponent extends StatelessWidget {
  ...
  Widget _htmlBuild(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: HtmlDropdownButtonWidget(value: value, trigger: trigger, optional: optional),
    );
  }
