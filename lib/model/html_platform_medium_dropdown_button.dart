...
typedef HtmlPlatformMediumChanged(String? value, int? privilegeLevel,);
...
class HtmlPlatformMediumDropdownButtonWidget extends StatefulWidget {
  ...
  HtmlPlatformMediumDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);
...
return widgets;
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'htmlPlatformMediums', widget.value, (newValue, _) {
                  setState(() {
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<HtmlPlatformMediumListBloc>(context).add(HtmlPlatformMediumChangeQuery(
