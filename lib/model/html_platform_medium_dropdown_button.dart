...
typedef HtmlPlatformMediumChanged = Function(
  String? value,
  int? privilegeLevel,
);
...
class _HtmlPlatformMediumDropdownButtonWidgetState
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<HtmlPlatformMediumListBloc, HtmlPlatformMediumListState>(
...
//        final values = state.values;
            ...
            ((false) == true)
                ? Container(
                    ...
                    child: dropdownButton<String>(
                      ...
                      value: value,
                      hint: text(
                          widget.app, context, 'Select a htmlPlatformMedium'),
            ...
            if (value != null)
              Align(
                  ...
                  child: button(
                    ...
                    onPressed: () {
                      updateComponent(
                          context, widget.app, 'htmlPlatformMediums', value,
                          (newValue, _) {
                        setState(() {
                          value = value;
                        });
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<HtmlPlatformMediumListBloc>(context)
        .add(HtmlPlatformMediumChangeQuery(
