...
class HtmlMediumCache implements HtmlMediumRepository {

  final HtmlMediumRepository reference;
  final Map<String?, HtmlMediumModel?> fullCache = Map();

  HtmlMediumCache(this.reference);
  ...
  Future<HtmlMediumModel?> get(String? id, {Function(Exception)? onError}) async {
  ...
  @override
  Future<List<HtmlMediumModel?>> valuesList({String? orderBy, bool? descending, Object? startAfter, int? limit, SetLastDoc? setLastDoc, int? privilegeLevel, EliudQuery? eliudQuery }) async {
    return await reference.valuesList(orderBy: orderBy, descending: descending, startAfter: startAfter, limit: limit, setLastDoc: setLastDoc, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery);
  }
  
  @override
  Future<List<HtmlMediumModel?>> valuesListWithDetails({String? orderBy, bool? descending, Object? startAfter, int? limit, SetLastDoc? setLastDoc, int? privilegeLevel, EliudQuery? eliudQuery }) async {
