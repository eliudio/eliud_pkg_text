...
typedef HtmlChanged(String? value);

class HtmlDropdownButtonWidget extends StatefulWidget {
  final AppModel app;
  final String? value;
  final HtmlChanged? trigger;
  final bool? optional;

  HtmlDropdownButtonWidget({ required this.app, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return HtmlDropdownButtonWidgetState();
  }
}

class HtmlDropdownButtonWidgetState extends State<HtmlDropdownButtonWidget> {
  HtmlListBloc? bloc;

  HtmlDropdownButtonWidgetState();

  @override
  void didChangeDependencies() {
    bloc = BlocProvider.of<HtmlListBloc>(context);
...
List<Widget> widgets(HtmlModel value) {
var app = widget.app;
var widgets = <Widget>[];
