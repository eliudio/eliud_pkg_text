...
class HtmlListWidget extends StatefulWidget with HasFab {
  ...
  HtmlListWidget({ Key? key, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);
...
//            app: accessState.app,
  ...
  Widget? getForm(value, action) {
    if (widget.form == null) {
      return HtmlForm(value: value, formAction: action);
    } else {
      return null;
    }
  }
