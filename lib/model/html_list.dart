...
import 'html_form.dart';


typedef HtmlWidgetProvider(HtmlModel? value);

class HtmlListWidget extends StatefulWidget with HasFab {
  AppModel app;
  BackgroundModel? listBackground;
  HtmlWidgetProvider? widgetProvider;
  bool? readOnly;
  String? form;
  HtmlListWidgetState? state;
  bool? isEmbedded;

  HtmlListWidget({ Key? key, required this.app, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);

  @override
  HtmlListWidgetState createState() {
    state ??= HtmlListWidgetState();
    return state!;
  }
...
class HtmlListWidgetState extends State<HtmlListWidget> {
  @override
      ...
      onPressed: () {
        Navigator.of(context).push(
          pageRouteBuilder(widget.app, page: BlocProvider.value(
              value: BlocProvider.of<HtmlListBloc>(context),
              child: HtmlForm(app:widget.app,
                  value: null,
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AccessBloc, AccessState>(
      ...
      if (accessState is AccessDetermined) {
        return BlocBuilder<HtmlListBloc, HtmlListState>(builder: (context, state) {
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return HtmlListItem(app: widget.app,
            value: value,
//            app: accessState.app,
  ...
  Widget? getForm(value, action) {
    if (widget.form == null) {
      return HtmlForm(app:widget.app, value: value, formAction: action);
    } else {
      return null;
    }
  }
...
class HtmlListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Dismissible(
      key: Key('__Html_item_${value.documentID}'),
